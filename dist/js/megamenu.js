...
},{"../../langs/da.json":5,"../../langs/de.json":6,"../../langs/en.json":7,"../../langs/es.json":8,"../../langs/et.json":9,"../../langs/fa.json":10,"../../langs/fi.json":11,"../../langs/hi.json":12,"../../langs/it.json":13,"../../langs/ja.json":14,"../../langs/ko.json":15,"../../langs/pl.json":16,"../../langs/pt_BR.json":17,"../../langs/ru.json":18,"../../langs/sv.json":19,"../../langs/zh_CN.json":20,"../../langs/zh_TW.json":21}],2:[function(require,module,exports){
...
module.exports = [
  ...
  },
  {
    ...
    links: [
      ...
      {
        id: "kudos",
        icon: `<svg xmlns="http://www.w3.org/2000/svg" xml:space="preserve" fill="currentColor" viewBox="0 0 16 16"><path fill-rule="evenodd" d="M16 3.1q-.5-.1-1 0-.3 0-.3-.3V2q0-.2-.2-.2h-.8q-.2 0-.2-.2V.8q0-.2-.2-.2H10q-.2 0-.2.2v.8q0 .3-.2.3h-.7q-.4-.1-.3.3v.6q0 .3-.2.3h-.8q-.2 0-.2-.3v-.7q0-.2-.2-.2h-.8q-.3 0-.3-.3V.8L6 .6H2.7q-.3 0-.3.2v.8q.1.3-.2.3h-.6q-.4 0-.4.2v.7q0 .3-.2.3H.3q-.3 0-.3.3v3.8C0 8 0 8 .8 8q.5-.1.4.5c0 .7 0 .7.8.7h.2q.2 0 .2.3l.1.9h1q.2 0 .2.2v.6q-.1.6.4.5c.8 0 .8 0 .8.8q-.1.5.4.4c.8 0 .8 0 .8.8q0 .5.4.4h.8q.2.4 0 .9 0 .5.5.4h.7q.2-.4 0-.9 0-.5.5-.4h.7q.3-.4.1-.8 0-.5.4-.4t.8 0q.2-.4 0-.8-.1-.5.5-.4h.4q.4 0 .4-.4c0-.9 0-.9.8-.8q.5 0 .4-.4t0-.8q.3-.1.8 0h.1q.4 0 .3-.4v-.8q.4-.2.9 0 .4 0 .4-.4V3m-11.1 1q0 .2-.2.2H4q-.4 0-.4.3v3.1q0 .3-.1.2h-.8q-.3 0-.3-.2V4.5q0-.3.3-.2h.6q.3 0 .4-.3v-.7q0-.2.2-.2c1.3 0 1-.3 1 1"/></svg>`,
